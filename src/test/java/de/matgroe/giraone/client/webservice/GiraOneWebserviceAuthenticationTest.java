...
public class GiraOneWebserviceAuthenticationTest {
  ...
  public void testSaltAndHashPassword(
      String salt, String sessionSalt, String password, String expected) {
    String a =
        auth.saltAndHashPassword(
            new GiraOneWebserviceSession(salt, sessionSalt, "GDS_1"), password);
  ...
  public void testComputeAuthToken(
      String salt, String sessionSalt, String password, String expected) {
    String token =
        auth.computeAuthToken(new GiraOneWebserviceSession(salt, sessionSalt, "GDS_1"), password);
