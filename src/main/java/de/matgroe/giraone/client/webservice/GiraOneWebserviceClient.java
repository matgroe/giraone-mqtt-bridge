...
public class GiraOneWebserviceClient {
    ...
    public void changeGiraOneDataPointValue(final GiraOneDataPoint dataPoint, Object value)
        ...
        this.execute(DiagnosticSetValue.builder().with(DiagnosticSetValue::setValue, value)
                .with(DiagnosticSetValue::setUrn, dataPoint.getUrn()).build());
    }

    public Object readGiraOneDataPointValue(final GiraOneDataPoint dataPoint) throws GiraOneCommunicationException {
        return this.execute(DiagnosticGetValue.builder().with(DiagnosticGetValue::setUrn, dataPoint.getUrn()).build());
    }
}
