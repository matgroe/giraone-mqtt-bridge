...
public class GiraOneWebsocketClient {
    ...
    final ReplaySubject<GiraOneWebsocketConnectionState> connectionState = ReplaySubject.createWithSize(1);
    ...
    public void changeGiraOneDataPointValue(final GiraOneDataPoint dataPoint, Object value) {
        if (connectionState.getValue() == GiraOneWebsocketConnectionState.Connected) {
            ...
            this.logger.warn("should changeGiraOneDataPointValue for dataPoint='{}' to '{}', but connectionState is {}",
                    dataPoint, value, connectionState.getValue());
            emitConnectionStateException(GiraOneClientConnectionState.Connected);
        }
    }
    ...
    public void onWebSocketError(Throwable throwable) {
        ...
        this.clientExceptions.onNext(new GiraOneClientException(GiraOneClientException.WEBSOCKET_COMMUNICATION, throwable));
