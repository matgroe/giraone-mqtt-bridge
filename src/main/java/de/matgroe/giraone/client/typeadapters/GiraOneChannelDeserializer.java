...
public class GiraOneChannelDeserializer extends GiraOneMessageJsonTypeAdapter
    ...
    @Override
    public GiraOneChannel deserialize(JsonElement jsonElement,  Type type,
    ...
    private void addDatapoints(GiraOneChannel channel, JsonDeserializationContext jsonDeserializationContext,
